...
|-------------|----------|--------|--------|-------|--------------|
| SCNN       | ResNet50 | Tusimple |acc: 95.33| [config](https://github.com/zkyseu/PPlanedet/blob/v2/configs/scnn/resnet50_tusimple.py)  | [model](https://github.com/zkyseu/PPlanedet/releases/download/SCNN/models.pd)|
