...
## News 
<ul class="nobull">
  <li>[2022-12-29] : We reproduce <a href="https://github.com/zkyseu/PPlanedet/tree/v3/configs/resa">RESA</a> and pretrain weight will be released soon. We also fix some bugs in detect.py
