...
<ul class="nobull">
  <li>[2023-02-24] :fire: We released the version5 of the PPLanedet. In V5, we reproduced more backbones and necks like CSPResNet, which is used in YOLOv6. With aforementioned components, we acihieved the state-of-the-art performance on CULane with CondLaneNet.
