...
<ul class="nobull">
  <li>[2023-02-24] :fire: We released the version5 of the PPLanedet. In V5, we reproduced more backbones and necks like CSPRepBiFPN, which is used in YOLOv6. With aforementioned components, we acihieved the state-of-the-art performance on CULane with CondLaneNet.
Compared with vanilla CondLaneNet, Our CondLaneNet achieve 79.92 F1 score and only contains 11M parameters. More details you can find in CondLaneNet <a href="https://github.com/zkyseu/PPlanedet/tree/v5/configs/condlane">config</a>.  
