...
If you do not have enough compute resource, we recommend that you can run our project at [AiStudio](https://aistudio.baidu.com/aistudio/index?ad-from=m-title), which can provide V100 with 32GB memory for free. We also open source the chinese version at AiStudio. Project link is [here](https://aistudio.baidu.com/aistudio/projectdetail/5286283?contributionType=1)

## News 
<ul class="nobull">
  <li>[2022-12-19] :fire: Versionv3 has been released. In this version, we reproduce the UFLD and the pretrain weight is available.
